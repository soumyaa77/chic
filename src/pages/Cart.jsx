...
async function displayRazorpay() {
        ...
        const result = await axios.post("https://chic-api.onrender.com/payment/orders", {total: total});
        ...
        const options = {
            ...
            handler: async function (response) {
                ...
                const result = await axios.post("https://chic-api.onrender.com/payment/success", data);
                dispatch(clearCart);
